...
const ItemModel = mongoose.model('Item', new Schema({
    item_id: {type: String, unique: true, required: true},
    item_brand_id: {type: Schema.Types.ObjectId, ref: 'ItemBrand'},
    item_type_id: {type: Schema.Types.ObjectId, ref: 'ItemType'},
